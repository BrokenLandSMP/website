      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {creators.map((creator, index) => (
            <a
              key={creator.name}
              href={`https://space.bilibili.com/search/user?keyword=${creator.name}`}
              target="_blank"
            ...
            >
              {/* Avatar */}
              <div className="w-28 h-28 flex-shrink-0 bg-slate-700 rounded-full flex items-center justify-center group-hover:bg-[#68447c] transition-colors">
